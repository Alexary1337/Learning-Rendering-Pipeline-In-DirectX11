...
bool SynColorShader::Initialize(ID3D11Device* device, HWND hwnd)
{
	bool result;
...
bool SynColorShader::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	HRESULT result;
...
void SynColorShader::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, WCHAR* shaderFilename)
{
	char* compileErrors;
...
void SynColorShader::RenderShader(ID3D11DeviceContext* deviceContext, int indexCount)
{
