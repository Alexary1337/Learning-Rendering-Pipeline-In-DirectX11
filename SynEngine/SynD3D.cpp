...
bool SynD3D::Initialize(int screenWidth, int screenHeight, bool vsync, HWND hwnd, bool fullscreen,
...
void SynD3D::BeginScene(float red, float green, float blue, float alpha)
{
	float color[4];
...
ID3D11Device* SynD3D::GetDevice()
{
	return m_device;
}

ID3D11DeviceContext* SynD3D::GetDeviceContext()
{
...
void SynD3D::GetVideoCardInfo(char* cardName, int& memory)
{
