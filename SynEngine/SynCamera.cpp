...
SynCamera::SynCamera(const SynCamera& other)
{
...
void SynCamera::SetPosition(float x, float y, float z)
{
	m_positionX = x;
	m_positionY = y;
	m_positionZ = z;
...
void SynCamera::SetRotation(float x, float y, float z)
{
	m_rotationX = x;
	m_rotationY = y;
	m_rotationZ = z;
...
void SynCamera::GetViewMatrix(DirectX::XMMATRIX& viewMatrix)
{
