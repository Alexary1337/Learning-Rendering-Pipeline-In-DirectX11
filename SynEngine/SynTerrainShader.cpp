...
SynTerrainShader::SynTerrainShader()
{
...
SynTerrainShader::SynTerrainShader(const SynTerrainShader& other)
{
...
bool SynTerrainShader::Initialize(ID3D11Device* device, HWND hwnd)
{
	bool result;

	// Initialize the vertex and pixel shaders.
	result = InitializeShader(device, hwnd, L"../SynEngine/terrainvertexshader.hlsl", L"../SynEngine/terrainpixelshader.hlsl");
	SAFE_CHECKEXIST(result);

	return true;
}

void SynTerrainShader::Shutdown()
{
...
bool SynTerrainShader::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	HRESULT result;
...
void SynTerrainShader::ShutdownShader()
{
...
void SynTerrainShader::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, WCHAR* shaderFilename)
{
	char* compileErrors;
...
void SynTerrainShader::RenderShader(ID3D11DeviceContext* deviceContext, int indexCount)
{
